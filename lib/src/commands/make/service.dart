  ...
  ServiceCommand() {
    argParser
      ...
      ..addOption(
        'name',
        abbr: 'n',
        help: 'Specifies a name for the service file.',
      )
      ..addOption(
        'output-dir',
  ...
  void run() async {
    ...
    var serviceLib = Library((serviceLib) {
      var generator = prompts.choose(
        'Choose which type of service to create',
        serviceGenerators,
      )!;
      ...
      if (argResults!['typed'] as bool) {
        serviceLib.directives.add(
          Directive.import('../models/${rc.snakeCase}.dart'),
        );
      }
    ...
    final serviceFile = File.fromUri(
